...
while True:
    ...
    for result in results:
        ...
        for box in boxes:
            ...
            if 0.94 >= confidence >= 0.925:
                total_count += 1
    # Display the resulting frame with the object count
    cv2.putText(frame, f"Objects detected: {object_count}", (10, 400), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
    cv2.putText(frame, f"Total Object Count: {total_count}", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
    # cv2.line(frame, (0, 200), (2000, 200), (255, 0, 255), 2)
    cv2.line(frame, (0, 100), (2000, 100), (255, 0, 255), 2)
